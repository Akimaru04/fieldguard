                ...
                <table class="w-full text-left">
                    ...
                    <tbody class="divide-y divide-slate-100">
                        ...
                        <tr>
                            ...
                            <td class="px-6 py-4">
                                <?php 
                                // Logic: If status is 'Flagged' use red, else use green
                                $isFlagged = ($log['status'] === 'Flagged'); 
                                ?>
                                <span class="px-2 py-1 rounded-lg text-xs font-bold <?= $isFlagged ? 'bg-red-100 text-red-700' : 'bg-green-100 text-green-700' ?>">
                                    <?= e($log['status']) ?>
                                </span>
                            </td>
                        </tr>
